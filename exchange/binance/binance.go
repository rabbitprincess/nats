...
func (b *Binanace) GetExchange() exchange.IBotExchange {
	return b.ex
}

func (b *Binanace) Subscribe(sub ...*subscription.Subscription) (chan any, error) {
...
func (b *Binanace) SubscribeFunc(ctx context.Context, fn func(data any), sub ...*subscription.Subscription) error {
